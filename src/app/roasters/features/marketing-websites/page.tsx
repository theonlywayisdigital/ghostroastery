      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Build full marketing sites for your brand. Landing pages, about
            pages, and more — with a drag and drop builder, custom domains, and
            SEO built in.
          </p>
          <p className="inline-block text-sm font-semibold text-white bg-neutral-900 border border-neutral-700 px-4 py-1.5 rounded-full">
            Coming Soon
          </p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-neutral-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-6">
            Get notified when Marketing Websites launches
          </h2>
          <p className="text-lg text-neutral-300 max-w-xl mx-auto mb-10">
            Create your free account and be the first to know when Marketing
