...
import { Tags, ArrowRight, CheckCircle2 } from "lucide-react";
      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Create and manage discount codes for every occasion. Percentage off,
            fixed amount, free shipping, or buy-one-get-one — set usage limits,
            expiry dates, and target specific products or customer groups.
          </p>
