...
export default function EmbeddedFormsPage() {
  return (
    <>
      {/* Hero */}
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Grow your email list and capture leads with embeddable forms. Add
            signup forms, contact forms, and lead magnets to your website or
            storefront — and automatically sync new contacts with your CRM and
            email campaigns.
          </p>
