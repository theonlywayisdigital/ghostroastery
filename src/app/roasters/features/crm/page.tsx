      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Build deeper relationships with your customers. See their full
            purchase history, track lifetime value, create segments for targeted
            marketing, and turn one-time buyers into loyal regulars.
          </p>
