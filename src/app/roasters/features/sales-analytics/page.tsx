      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            See exactly how your roastery is performing. Revenue dashboards,
            best-selling products, customer acquisition trends, and seasonal
            insights — all the data you need to make smarter decisions.
          </p>
