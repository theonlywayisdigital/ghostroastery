      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Track every order from the moment it&apos;s placed to the moment it
            arrives. Real-time status updates, dispatch tracking, and automated
            customer notifications — so you always know where every bag of
            coffee is.
          </p>
