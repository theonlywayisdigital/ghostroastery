...
export const metadata: Metadata = {
  title: "Storefront",
  description:
    "Launch a fully branded online coffee shop — your products, your domain, your brand.",
};
      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Launch a fully branded online coffee shop — your products, your
            domain, your brand. Everything you need to sell direct-to-consumer,
            with subscriptions, discount codes, and a checkout that converts.
          </p>
      ...
      <section className="py-20 lg:py-28 bg-neutral-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-6">
            Launch your online coffee shop
          </h2>
          <p className="text-lg text-neutral-300 max-w-xl mx-auto mb-10">
            Create your account and start selling directly to customers. No
