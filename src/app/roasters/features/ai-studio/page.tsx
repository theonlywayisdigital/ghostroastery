      ...
      <section className="py-20 lg:py-28 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto mb-3">
            Let AI handle the heavy lifting. Generate product descriptions,
            social media captions, email copy, blog posts, and marketing images
            — all trained on specialty coffee language and your brand voice.
          </p>
