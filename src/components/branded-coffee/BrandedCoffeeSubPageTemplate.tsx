...
interface BrandedCoffeeSubPageProps {
  heroHeadline: string;
  heroAccent: string;
...
export function BrandedCoffeeSubPageTemplate({
  heroHeadline,
  heroAccent,
  heroDescription,
  heroImage,
  ...
  return (
    <>
      ...
      <Section dark>
        <FadeIn>
          <div className="max-w-3xl mx-auto">
            <SectionHeader title={whyTitle} align="left" />
            <div className="space-y-6 text-lg text-neutral-300">
              {whyDescription.map((paragraph, index) => (
      ...
      {useCases.length > 0 && (
        <Section>
          <FadeIn>
            <SectionHeader title="Ideas to get you started" />
          </FadeIn>
        ...
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-neutral-300 mb-8 max-w-xl mx-auto">
              Design your label, pick your roast, and order online. From 25
              bags, delivered in 7–10 working days.
            </p>
